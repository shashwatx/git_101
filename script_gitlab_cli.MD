## Creating gitlab person access token.
See instructions [here](https://docs.gitlab.com/ee/user/profile/personal_access_tokens.html).
## Command line gitlab repo creation.
```
#!/bin/bash
